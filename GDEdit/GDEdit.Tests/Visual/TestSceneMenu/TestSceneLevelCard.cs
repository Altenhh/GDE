    ...
    public class TestSceneLevelCard : TestScene
    {
        ...
        public TestSceneLevelCard()
        {
            ...
            Add(container = new Container
            {
                ...
                {
                    card = new LevelCard(new Level
                    {
                        Name = "Test Level",
                        Description =
                            "This is my own completely original level, filled with butterflies and princesses. Also..."
                    })
                }
            });

            AddToggleStep("Toggle details",
                          v => card.State.Value = v ? CarouselItemState.Selected : CarouselItemState.NotSelected);
