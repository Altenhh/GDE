...
namespace GDEdit.App.Overlays.Level
{
    public class ObjectDensity : CompositeDrawable
    {
        ...
        /// <summary>Resolution at which the graphs renders at. Set to 1 for full resolution.</summary>
        ...
        /// <summary>The colour which low-range frequencies should be colourised with. May be null for this frequency range to not be colourised.</summary>
        ...
        /// <summary>The colour which mid-range frequencies should be colourised with. May be null for this frequency range to not be colourised.</summary>
        ...
        /// <summary>The colour which high-range frequencies should be colourised with. May be null for this frequency range to not be colourised.</summary>
        ...
        public void CalculateValues()
        {
            ...
            var granularity = (int) (lastObj / 30);
        ...
        public void AddGraph()
        {
            ...
            var step = values.Length / (DrawWidth / Resolution);

            for (float i = 0; i < values.Length; i += step) newValues.Add((float) values[(int) i] / max);
